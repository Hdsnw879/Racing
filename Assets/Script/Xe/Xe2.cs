...
public class Xe2 : MonoBehaviour
{
   // Start is called before the first frame update
    ...
    // Settings
    private float acceleration=350, brakeForce=700, maxSteerAngle=15;
    ...
    private void Acceleration() 
    {
        if(wheelCollider[0].isGrounded && inputManager.verticalInput != 0){
            ...
            wheelCollider[0].motorTorque = currentAcceleration + 150;
            wheelCollider[1].motorTorque = currentAcceleration + 150;
            wheelCollider[2].motorTorque = currentAcceleration - 150;
            wheelCollider[3].motorTorque = currentAcceleration - 150;
        }else
        {
